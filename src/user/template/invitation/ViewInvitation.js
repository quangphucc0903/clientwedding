            ...
            try {
                ...
                if (isPreview) {
                    ...
                    if (storedInvitation) {
                        ...
                        showSnackbar("No invitation data found in sessionStorage.", "error");
                    }
                } else if (linkName) {
                ...
                if (currentInvitation?.metadata) {
                    const processedSections = processMetadataToSections(currentInvitation.metadata);
        ...
        >
            ...
            >
                {sections.map((section) => (
                    <Box key={section.id} sx={{ position: "relative", width: "100%", height: "100%" }}>
